...
<body>
    <div class="container">
        <div class="col ">
            <h3 class="text-center">FORM TAMBAH MENU</h3>
            <hr>
            <form action="/pemilik/simpan" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3 text-left d-flex justify-content-center">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control <?=
                                                                ($validation->hasError('nama_menu')) ? 'is-invalid' : ''; ?>" id="nama_menu" name="nama_menu" autofocus value="<?= old('nama_menu'); ?>">
                ...
                <div class="row mb-3 text-left d-flex justify-content-center">
                    <label for="detail" class="col-sm-2 col-form-label">Detail Menu</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control <?=
                                                                ($validation->hasError('detail')) ? 'is-invalid' : ''; ?>" id="detail" name="detail" autofocus value="<?= old('detail'); ?>">
                        <div id="judulFeedback" class="invalid-feedback">
                ...
                <div class="row mb-3 text-left d-flex justify-content-center">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control <?=
                                                                ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" name="harga" autofocus value="<?= old('harga'); ?>">
                        <div id="judulFeedback" class="invalid-feedback">
