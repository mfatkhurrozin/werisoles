...
<body>
    ...
    <div class="container">
        <div class="col ">
            ...
            <hr>
            <form action="/nota/update/<?= $nota['id_nota']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="text-left ">
                    ...
                    <div class="row mb-3 text-left d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control  <?=
                                                                    ($validation->hasError('status')) ? 'is-invalid' : ''; ?>" id="status" name="status" autofocus value="<?= (old('status')) ? old('status') : $nota['status'] ?>">
